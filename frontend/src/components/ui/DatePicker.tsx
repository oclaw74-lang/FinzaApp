...
const DatePicker = React.forwardRef<HTMLInputElement, DatePickerProps>(
  (
    { className, label, error, id, value, placeholder = 'dd/MM/yyyy', disabled, ...props },
    ref
  ) => {
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          {/* Display trigger — pointer-events-none para que el input debajo reciba los clicks */}
          <div
            className={cn(
          ...
          {/* Input nativo invisible — cubre toda el área y abre el picker del SO */}
          <input
            id={inputId}
            type="date"
            value={value}
