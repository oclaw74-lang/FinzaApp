...
-- NUEVOS RETOS
-- =============================================
INSERT INTO retos (id, titulo, descripcion, tipo, ahorro_estimado, icono) VALUES
  (gen_random_uuid(), 'Regla de las 24 horas', 'Antes de comprar algo no esencial, espera 24 horas para decidir si realmente lo necesitas', 'semanal', 1500.00, '⏰'),
  (gen_random_uuid(), 'Sin restaurantes esta semana', 'Lleva tu almuerzo y prepara tus cenas en casa durante 7 días consecutivos', 'semanal', 2000.00, '🍱'),
  (gen_random_uuid(), 'Elimina una suscripción innecesaria', 'Revisa tus suscripciones activas y cancela al menos una que no uses regularmente', 'mensual', 500.00, '✂️'),
  (gen_random_uuid(), 'Semana sin tarjeta de crédito', 'Paga todo con efectivo o transferencia esta semana para ser más consciente de tus gastos', 'semanal', 3000.00, '💳'),
  (gen_random_uuid(), 'Aporta a tu meta de ahorro', 'Haz al menos una contribución a cada una de tus metas activas esta semana', 'semanal', 0.00, '🎯'),
  (gen_random_uuid(), 'Investiga antes de comprar', 'Por cada compra mayor a RD$500, compara precios en al menos 2 lugares antes de decidir', 'semanal', 1000.00, '🔍');

-- =============================================
-- NUEVAS LECCIONES
-- =============================================
INSERT INTO lecciones (id, titulo, descripcion_corta, contenido_json, nivel, duracion_minutos, orden) VALUES
  (
    gen_random_uuid(),
